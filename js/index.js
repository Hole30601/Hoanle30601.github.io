...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.facebook.com/profile.php?id=100095064243278&mibextid=PlNXYD');
    });
});
document.addEventListener('DOMContentLoaded', function () {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.instagram.com/nguyentoanle2000?igsh=dDhmaWY5b3M1a3V3&utm_source=qr');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Tiktok');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.tiktok.com/@hoangnguyenios?_t=8l5KcVyC73h&_r=1');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Youtube');
    telegramDiv.addEventListener('click', function () {
        window.open('https://youtube.com/@HNIOSVIP?si=5-la0meQPQT1YLdR');
    });
});
...
console.log('%c- Có vẻ như bạn đang cố tình ăn cắp mã nguồn của tôi </ Hoang Nguyen >.', 'color: #444; font-size: 25px; font-family: sans-serif;');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var audio = new Audio('./audio/HoangNguyen.mp3');
...
welcomeText.textContent = "Designed By HoangLeLe =))";
